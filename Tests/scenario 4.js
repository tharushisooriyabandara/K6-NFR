...
export default function main() {
  ...
  getOrder: {
    shipping_method: "DELIVERY", // changed from COLLECTION to DELIVERY
    shop_id: 2,
    platform_id: 5,
    sub_total: 7693.00,
    delivery_date_time: "2025-06-11T17:47:30+05:30",
    delivery_distance: 4.5,  // example delivery distance in km
    vouchers: [],
    ...
    delivery_cost: 225, // example delivery fee, adjusted accordingly
    total_tax: 0,
    orderproducts: [
      {
    ...
    customer: {
      ...
      last_name: "Tharushi",
      location_id: "501",
      lat_lng: { lat: 6.9271, lng: 79.8612 }, // example coordinates for delivery location
      email: "sooriyabandaratharushi@gmail.com",
      address: "123 Example St, Colombo",
      flat_no: "A-101",
      contact_number: "+94762881444",
      phone: "762881444",
      country_code: "+94"
    },
    receiver: {
    ...
    order_shop_fees: [{ shop_fee_id: 1, amount: 0 }],
    total_fee: 0
  },
  device_platform: "web",
  rwg_token: "",
