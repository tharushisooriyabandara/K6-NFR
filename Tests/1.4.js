...
export default function main() {
  ...
  group(
    'page_1 - https://webshop-dev-v1-1.delivergate.com/Bambalapitiya/food-menu;method=Collection',
    function () {
      ...
      response = http.post(
        ...
        '{"event_type":"menu_viewed","campaign_id":"","path":"food_menu_page","outlet_id":"2","tenant":"subway","platform":"WEB","brand_id":"1","session_id":"subway1225e3","user_id":"1809"}',
        {
          headers: {
            accept: 'aplication/json',
            'access-control-allow-origin': '*',
