...
export function handleSummary(data) {
  ...
  console.log(`Avg duration: ${data.metrics.http_req_duration.avg.toFixed(2)} ms`);
  console.log(`Min duration: ${data.metrics.http_req_duration.min.toFixed(2)} ms`);
  console.log(`Med duration: ${data.metrics.http_req_duration.med.toFixed(2)} ms`);
  console.log(`Max duration: ${data.metrics.http_req_duration.max.toFixed(2)} ms`);
  console.log(`P(90): ${data.metrics.http_req_duration['p(90)'].toFixed(2)} ms`);
  console.log(`P(95): ${data.metrics.http_req_duration['p(95)'].toFixed(2)} ms`);
  console.log(`Error %: ${(data.metrics.http_req_failed.rate * 100).toFixed(2)}%`);
  console.log(`Received KB/sec: ${(data.metrics.data_received.rate / 1024).toFixed(2)} kB/s`);
  console.log(`Sent KB/sec: ${(data.metrics.data_sent.rate / 1024).toFixed(2)} kB/s`);
...
//   duration: '1m',            // 2 minute duratio              // 2 iterations per VU
//   thresholds: {
